    ...
    def _allocate_kv_cache_tensors(
        ...
        for kv_cache_tensor in kv_cache_config.kv_cache_tensors:
            ...
            index_cache_ = torch.zeros((num_blocks *
                                    kv_cache_spac.index_cache_size_bytes),
                                    dtype=torch.int8,
                                    device=self.device)
            tensor = [cache_, scale_, index_cache_]
        ...
        for i, kv_cache_group_spec in enumerate(
            ...
            for layer_name in kv_cache_group_spec.layer_names:
                ...
                if isinstance(kv_cache_spec, AttentionSpec):
                    ...
                    index_cache_ = index_cache_.view(kv_cache_spec.dtype).view(index_cache_shape)
        ...
        for layer_name, attn_module in layers.items():
            ...
            if attn_module.attn_type == AttentionType.DECODER:
                if attn_module.sliding_window is not None:
                    ...
                    if self.vllm_config.model_config.hf_text_config.model_type == "deepseek_v3":
                        index_head_dim = 128
                        index_n_heads = 1
