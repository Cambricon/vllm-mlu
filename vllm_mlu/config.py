...
@property
def vllm__config__ModelConfig__is_deepseek_mla(self) -> int:
    if not hasattr(self.hf_text_config, "model_type"):
        return False
    elif self.hf_text_config.model_type in \
        ('deepseek_v2', 'deepseek_v3', 'deepseek_mtp', 'kimi_k2', 'xs'):
...
MluHijackObject.apply_hijack(ModelConfig,
                             ModelConfig.is_deepseek_mla,
                             vllm__config__ModelConfig__is_deepseek_mla)
